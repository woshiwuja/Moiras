...
// Rimosse le uniform tiling/offset perché processate nel vertex shader
...
void main()
{
    // USIAMO DIRETTAMENTE fragTexCoord
    // Non serve più: vec2 uv = fragTexCoord * tiling + offset;
    ...
    if (useTexNormal == 1) {
        ...
        // Usiamo la matrice TBN calcolata nel vertex shader
